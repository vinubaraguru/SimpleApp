...
public class HiringAppliedCandidatesListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        hiringAppliedCandidateListView();
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                swipeRefreshHiringAppliedCandidateListView();
            }
        });
    ...
    private void hiringAppliedCandidateListView() {
    ...
    private void swipeRefreshHiringAppliedCandidateListView(){
