...
public class HiringNotEvaluatedCandidatesListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        hiringNotEvaluatedCandidateListView();
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                swipeRefreshHiringNotEvaluatedCandidateListView();
            }
        });
    ...
    private void hiringNotEvaluatedCandidateListView() {
    ...
    private void swipeRefreshHiringNotEvaluatedCandidateListView(){
