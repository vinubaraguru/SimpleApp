...
public class HiringRejectedCandidatesListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        hiringRejectedCandidateListView();
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                swipeRefreshHiringRejectedCandidateListView();
            }
        });
    ...
    private void hiringRejectedCandidateListView() {
    ...
    private void swipeRefreshHiringRejectedCandidateListView(){
