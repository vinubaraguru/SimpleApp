...
public class HiringShortlistedCandidatesListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        hiringShortlistedCandidateListView();
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                swipeRefreshHiringShortlistedCandidateListView();
            }
        });
    ...
    private void hiringShortlistedCandidateListView() {
    ...
    private void swipeRefreshHiringShortlistedCandidateListView(){
