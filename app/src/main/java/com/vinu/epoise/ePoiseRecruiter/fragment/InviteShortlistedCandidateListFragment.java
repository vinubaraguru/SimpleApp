...
public class InviteShortlistedCandidateListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        inviteShortlistedCandidateListView();
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                swipeRefreshInviteShortlistedCandidateListView();
            }
        });
    ...
    private void inviteShortlistedCandidateListView() {
    ...
    private void swipeRefreshInviteShortlistedCandidateListView(){
        if(isNetworkAvailable()){
