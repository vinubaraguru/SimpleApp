...
public class TrainingAppliedCandidatesListFragment extends Fragment {
    ...
    private ArrayList<TrainingAppliedCandidateList.Contact> trainingAppliedCandidateList;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        trainingAppliedCandidateListView();
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                swipeRefreshTrainingAppliedCandidateListView();
            }
        });
    ...
    private void trainingAppliedCandidateListView() {
            ...
            trainingOppListCall.enqueue(new Callback<TrainingAppliedCandidateList>() {
                ...
                public void onResponse(Call <TrainingAppliedCandidateList> call, Response<TrainingAppliedCandidateList> response) {
                    ...
                    if(response.isSuccess()){
                        trainingAppliedCandidateList = response.body().getContacts();
                        for (int i = 0; i < trainingAppliedCandidateList.size(); i++) {
                            TrainingAppliedCandidateList.Contact contact = trainingAppliedCandidateList.get(i);
    ...
    private void swipeRefreshTrainingAppliedCandidateListView(){
