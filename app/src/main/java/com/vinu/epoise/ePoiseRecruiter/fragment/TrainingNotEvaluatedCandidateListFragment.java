...
public class TrainingNotEvaluatedCandidateListFragment extends Fragment {
    ...
    private ArrayList<TrainingAppliedCandidateList.Contact> trainingNotEvaluatedCandidateArrayList;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        trainingNotEvaluatedCandidateListView();
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                swipeRefreshTrainingNotEvaluatedCandidateListView();
            }
        });
    ...
    private void trainingNotEvaluatedCandidateListView() {
            ...
            trainingOppListCall.enqueue(new Callback<TrainingAppliedCandidateList>() {
                ...
                public void onResponse(Call<TrainingAppliedCandidateList> call, Response<TrainingAppliedCandidateList> response) {
                    ...
                    if (response.isSuccess()) {
                        trainingNotEvaluatedCandidateArrayList = response.body().getContacts();
                        for (int i = 0; i < trainingNotEvaluatedCandidateArrayList.size(); i++) {
                            TrainingAppliedCandidateList.Contact contact = trainingNotEvaluatedCandidateArrayList.get(i);
    ...
    private void swipeRefreshTrainingNotEvaluatedCandidateListView(){
